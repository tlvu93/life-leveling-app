  ...
  theme: {
    extend: {
      colors: {
        ...
        // Secondary colors for variety and engagement
        secondary: {
          50: "#f0f9ff",
          100: "#e0f2fe",
          200: "#bae6fd",
        ...
        skill: {
          novice: "#fef3c7",
          "novice-border": "#f59e0b",
          intermediate: "#ddd6fe",
          "intermediate-border": "#8b5cf6",
          advanced: "#dcfce7",
          "advanced-border": "#10b981",
          expert: "#fce7f3",
          "expert-border": "#ec4899",
        },
