...
export interface CommitmentLevelCardProps {
  title: string;
  description: string;
  details: string;
  icon: string;
  ...
  disabled?: boolean;
  className?: string;
  variant?: "casual" | "average" | "invested" | "competitive";
}
...
export const CommitmentLevelCard = React.forwardRef<
  HTMLButtonElement,
  CommitmentLevelCardProps
>(
  (
    {
      title,
...
CommitmentLevelCard.displayName = "CommitmentLevelCard";
